...
public final class Main {
    ...
    public final com.example.weatherapp.data.remote.responses.Main copy(double feels_like, int humidity, int pressure, double temp, double temp_max, double temp_min) {
        return null;
    }
